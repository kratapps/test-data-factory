...
- Fields in the `metadata defaults` sObject. This sObject is build from Test_Data_Factory_Default\_\_mdt metadata.
...
Define default fields values using Test_Data_Factory_Default\_\_mdt custom metadata.
...
- name the class after the SObject (without \_\_c and underscores)
  with `Factory` suffix
